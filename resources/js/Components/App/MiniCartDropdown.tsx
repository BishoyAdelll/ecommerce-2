    ...
    <div className="dropdown dropdown-end">
      ...
      <div
        ...
        <div className="card-body">
          ...
          <div className={'my-4 max-h-[300px] overflow-auto'}>
            {miniCartItems.length === 0 &&(
              ...
              <div key={item.id} className={'flex gap-4 p-3'}>
                <Link className={'w-16 h-16'} href={productRoute(item)} >
                  <img src={item.image} alt={item.title} className={'max-w-full max-h-full flex justify-center items-center '}/>
                </Link>
          ...
          <span className={'text-lg'}>Subtotal:
